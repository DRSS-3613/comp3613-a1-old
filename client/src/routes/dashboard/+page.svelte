...
<div class="sticky top-0 w-full z-40 bg-rural-blue h-28">
	<Nav />
</div>
<div class="flex flex-no-wrap">
	<div class="fixed z-30 bg-rural-blue">
		<DashboardSideBar />
	</div>
	<div
    ...
    <div class="w-full">
        <form>   
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm  bg-gray-50 rounded-lg border border-gray-200" placeholder="Search Mockups, Logos..." required>
